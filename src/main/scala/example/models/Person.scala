...
final case class Person(
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): models.Person = {
    ...
    def companion = models.Person
}

object Person extends scalapb.GeneratedMessageCompanion[models.Person] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[models.Person] = this
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, _root_.scala.Any]): models.Person = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[models.Person] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = models.Person(
  )
  implicit class PersonLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, models.Person]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, models.Person](_l) {
